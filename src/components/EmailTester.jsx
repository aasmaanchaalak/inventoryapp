...
const EmailTester = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/invoice/test-email', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-bold text-gray-900 mb-6">Email Service Tester</h2>
      
      <div className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Test Email Configuration</h3>
        <p className="text-gray-600 mb-4">
          This tool allows you to test the email service configuration. Enter an email address to send a test email.
        </p>
      </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-green-700">
                ...
                <p className="mt-2">Please check your email inbox for the test message.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 p-4 bg-gray-50 border border-gray-200 rounded-md">
        <h3 className="text-sm font-medium text-gray-800 mb-2">Email Configuration</h3>
        <div className="text-sm text-gray-700 space-y-1">
          <p><strong>Service:</strong> Gmail SMTP</p>
          <p><strong>From Email:</strong> your-email@gmail.com (configure in .env)</p>
          <p><strong>From Name:</strong> Steel Tube Industries Ltd.</p>
          <p><strong>Subject:</strong> Tax Invoice from Steel Tube Industries Ltd. - [Invoice Number]</p>
          <p className="mt-2 text-xs text-gray-500">
            Note: Update EMAIL_USER and EMAIL_PASS environment variables with your Gmail credentials.
