            ...
            <div className="flex-1">
              ...
              {errors.invoiceId && (
                <p className="text-red-600 text-sm mt-1">
                  {/* @ts-expect-error - Type issue with react-hook-form error message */}
                  ...
                  ([event, summary]) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-600">
                        <p>
                          Last:{' '}
                          {(summary as any).lastOccurrence
                            ? formatTimestamp((summary as any).lastOccurrence)
                            : 'Never'}
                        </p>

                        <p>By: {(summary as any).performedBy.join(', ')}</p>
                      </div>
                    </div>
                  )
                )}
