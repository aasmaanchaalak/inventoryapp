...
const TallyPush = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-bold text-gray-900 mb-6">Tally Integration</h2>
      
      <div className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Push DO2 to Tally</h3>
        <p className="text-gray-600 mb-4">
          Enter a DO2 ID to push the executed dispatch order data to Tally ERP system.
          The system will generate XML and JSON payloads formatted for Tally integration.
        </p>
      </div>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-md">
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700">{result.message}</div>
              </div>
            </div>
          </div>

          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Push Summary</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm font-medium text-gray-600">DO2 Number</p>
                <p className="text-lg font-semibold text-gray-900">{result.data.do2Number}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600">Customer</p>
                <p className="text-lg font-semibold text-gray-900">{result.data.customerName}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600">Total Items</p>
                <p className="text-lg font-semibold text-gray-900">{result.data.totalItems}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600">Subtotal</p>
                <p className="text-lg font-semibold text-gray-900">₹{result.data.subtotal}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600">Total Tax</p>
                <p className="text-lg font-semibold text-gray-900">₹{result.data.totalTax}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600">Grand Total</p>
                <p className="text-lg font-semibold text-gray-900">₹{result.data.grandTotal}</p>
              </div>
            </div>
          </div>

          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Generated Payloads</h3>
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium text-gray-700 mb-2">XML Format</h4>
