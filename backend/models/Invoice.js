...
const invoiceSchema = new mongoose.Schema({
  ...
  auditTrail: [{
    event: {
      type: String,
      enum: ['generated', 'downloaded', 'emailed', 'tally_push', 'tally_push_success', 'tally_push_failed', 'viewed', 'modified', 'deleted'],
      required: true
    },
    timestamp: {
      type: Date,
...
invoiceSchema.methods.addAuditEntry = function(event, performedBy = 'system', notes = '', metadata = {}) {
